...
export default function AnimatedButton() {
  ...
  return (
    <div className="relative w-[420px] h-[65px] text-black flex items-center justify-center group overflow-hidden rounded-md bg-transparent">
      {/* Border Animation */}
      {showButton && (
        <div className="absolute inset-0 border border-black rounded-md animate-borderSweep z-0"></div>
      )}
