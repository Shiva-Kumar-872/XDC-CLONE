...
export default function AnimatedButton() {
  ...
  return (
    <div className="relative w-full h-full text-black flex items-center  justify-start group overflow-hidden pl-9   bg-transparent">
      ...
      {showButton && (
        <div>
        <button className="relative border-l-0 border-r-0 border-b-0 flex items-center justify-center w-full font-sans font-light text-2xl px-6 z-10 overflow-hidden bg-transparent ">
          {/* Arrow Icon */}
